...
import { getMCPHub, getAgentMonitor, getContextManager } from './core-services.js';
...
export class AgentCoordinator {
    ...
    async requestHandoff(request: HandoffRequest): Promise<boolean> {
        const registry = getAgentRegistry();
        const mcpHub = getMCPHub();
        // Get context manager for potential context sharing
        const _contextManager = getContextManager();
