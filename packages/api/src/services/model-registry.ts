...
export const MODEL_REGISTRY: Record<string, ModelConfig> = {
    ...
    // Groq Llama 3.3 70B - RECOMMENDED FAST MODEL (very fast inference)
    'llama-3.3-70b-versatile': {
        id: 'llama-3.3-70b-versatile',
        name: 'Llama 3.3 70B Versatile (Groq)',
        provider: 'groq',
        tier: 'fast', // Using as FAST model - Groq has very fast inference
        ...
        supportsStreaming: true,
        supportsJsonMode: true,
        avgLatencyMs: 300, // Groq is very fast
        qualityScore: 88,
        baseUrl: 'https://api.groq.com/openai/v1',
        apiKeyEnvVar: 'GROQ_API_KEY',
    },

    // Groq Llama 3.1 8B - Ultra fast, lower quality
...
export function getRecommendedModelPair(): [ModelConfig, ModelConfig] {
    // Recommended: Llama 3.3 via Groq (FAST) + GLM-4.6 via Z.AI (POWER)
    // Fallback chain: Groq -> DeepSeek -> GPT-4o-mini
